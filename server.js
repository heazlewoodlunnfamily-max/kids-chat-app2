...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .input-field { flex: 1; padding: 13px 16px; border: 2px solid #e0e0e0; border-radius: 22px; font-size: 15px; font-family: inherit; font-weight: 500; transition: all 0.3s; height: 44px; }
        .input-field:focus { outline: none; border-color: #667eea; box-shadow: 0 0 0 3px rgba(102, 126, 234, 0.1); }
        .input-field::placeholder { color: #999; }
        
        .btn-emoji { border: none; padding: 10px 12px; border-radius: 14px; font-size: 18px; cursor: pointer; transition: all 0.3s; font-weight: 600; height: 44px; display: flex; align-items: center; background: white; border: 2px solid #ffc107; color: #333; }
        .btn-emoji:hover { background: #ffc107; }
        
        .btn-games { border: none; padding: 10px 12px; border-radius: 14px; font-size: 18px; cursor: pointer; transition: all 0.3s; font-weight: 600; height: 44px; display: flex; align-items: center; background: linear-gradient(90deg, #FF6B9D 0%, #FFA06B 25%, #FFE66D 50%, #95E1D3 75%, #667eea 100%); color: white; box-shadow: 0 3px 10px rgba(102, 126, 234, 0.3); }
