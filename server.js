...
.msg.mam .bubble { background: #95e1d3; color: white; }
.msg.mum .bubble { background: #f38181; color: white; }
.msg.nan .bubble { background: #aa96da; color: white; }
.msg.poppy .bubble { background: #fcbad3; color: white; }
.msg.rishy .bubble { background: #ffd1b3; color: white; }
.msg.hilary .bubble { background: #a8e6cf; color: white; }
...
<div class="container" id="app">
  ...
  <div class="input-area">
    <button class="emoji-btn" onclick="addEmoji()" title="Add emoji">😀</button>
...
let currentChat = GROUP_CHAT;
let allChats = [GROUP_CHAT];
let messages = {};
let ws = null;
let connected = false;
