...
<body>
    ...
    <div class="container" id="app">
        ...
        <div class="input-area">
            ...
            <div id="composeArea" class="compose-area" style="display: none;">
                <div class="compose-title">✍️ Compose</div>
            ...
            <div class="input-container">
                <button class="compose-btn-toggle" onclick="toggleCompose()">✍️</button>
    ...
    <script>
        ...
        let showEmojiPicker = false, recognition = null, showCompose = false, drafts = {};
        ...
        function renderTabs() {
            ...
            allChats.forEach(chatId => {
                ...
                btn.onclick = () => { currentChat = chatId; renderTabs(); render(); showEmojiPicker = false; document.getElementById('emojiPicker').style.display = 'none'; };
                div.appendChild(btn);
            });
        }
        ...
        function toggleCompose() {
            ...
            if (showCompose) {
                ...
                if (drafts[currentChat]) document.getElementById('composeText').value = drafts[currentChat];
            }
        }
        ...
        document.addEventListener('input', (e) => {
            if (e.target.id === 'composeText') {
                drafts[currentChat] = e.target.value;
                if (e.target.value) localStorage.setItem('draft_' + currentChat, e.target.value);
                else localStorage.removeItem('draft_' + currentChat);
            }
        });
