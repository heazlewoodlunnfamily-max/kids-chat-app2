            ...
            <div id="gamesPanel" class="games-panel">
                ...
                <div id="drawContainer" style="display: none;">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 6px; margin-bottom: 8px;">
                        ...
                        <button class="game-btn" onclick="addKawaii('^ _ ^')">Happy</button>
                        <button class="game-btn" onclick="addKawaii('♡')">Heart</button>
                        <button class="game-btn" onclick="addKawaii('✨')">Sparkle</button>
                        <button class="game-btn" onclick="addKawaii('OwO')">Surprised</button>
                        <button class="game-btn" onclick="addKawaii('UwU')">Uwu</button>
                        <button class="game-btn" onclick="addKawaii('^_^')">Joy</button>
                        <button class="game-btn" onclick="addKawaii('★')">Star</button>
                    </div>
