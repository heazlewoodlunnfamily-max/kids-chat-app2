...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .rps-result { text-align: center; padding: 12px; background: #e8f5e9; border-radius: 10px; color: #2e7d32; font-weight: 600; margin-bottom: 8px; }
    </style>
</head>
<body>
        ...
        function render() {
            ...
            msgs.forEach(m => {
                ...
                if (m.isDrawing) {
                    ...
                    d.innerHTML = '<div class="message-sender">' + (m.user === 'system' ? 'Game' : USERS[m.user]) + '</div><div class="message-bubble">' + m.text + '</div>';
                }
                div.appendChild(d);
            });
