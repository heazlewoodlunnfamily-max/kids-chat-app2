...
<body>
    ...
    <script>
        ...
        // Initialize audio context on first user interaction (iPhone requirement)
        function initAudio() {
            try {
                const ctx = new (window.AudioContext || window.webkitAudioContext)();
                if (ctx.state === 'suspended') {
        ...
        // Request permissions and initialize audio on first click
