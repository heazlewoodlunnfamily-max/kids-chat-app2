...
// HTML - Perfect design with rainbows and happy cats
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .message-sender { font-size: 11px; color: #999; margin: 3px 0 4px 0; font-weight: 700; text-transform: uppercase; letter-spacing: 0.3px; }
...
<body>
    ...
    <script>
        ...
        let showCompose = false, soundEnabled = localStorage.getItem('soundEnabled') !== 'false';
